...
class LinkedList:
    ...
    def sortByPrice(self):
		# ------------------------------------------------------------------------------
        # -------------------------- Start your code here ------------------------------
        def findFirstLargeAndDelete(linkedList):
            currNode = linkedList
            while True:
                if currNode.data.price < currNode.next.data.price:
        ...
        def InsertIntoOrderedList(linkedList, firstLargePrice):
            currNode = linkedList
            if currNode.data.price < firstLargePrice.data.price:
                firstLargePrice.next = linkedList
                linkedList = firstLargePrice
            else:
                while True:
                    if currNode.next == None: break
                    if currNode.next.data.price < firstLargePrice.data.price:
                        firstLargePrice.next = currNode.next
                        currNode.next = firstLargePrice
                        break
                    currNode = currNode.next
            return linkedList
        
        while True:
            firstLargePrice = findFirstLargeAndDelete(self.head)
            if (firstLargePrice == None): break
            self.head = InsertIntoOrderedList(self.head, firstLargePrice)
        # -------------------------- End your code here --------------------------------
        # ------------------------------------------------------------------------------
    ...
    def f3(self):
        ...
        currNode = self.head   
        while True:
            makeCar = currNode.data.make
            if makeCar.startswith('B'):
                currNode.data.color = 'ALPINE WHITE'
                break
            currNode = currNode.next
            if currNode.next == None: break 
    ...
    def f5(self):
        ...
        currNode = self.head
        if currNode.data.make == 'BMW':
            self.head = self.head.next
        else:
            while True:
                if currNode.next.data.make == 'BMW':
                    currNode.next = currNode.next.next
                    break
                currNode = currNode.next
                if currNode.next == None: break 
